...
const inputClass =
  'h-10 w-full rounded-xl border border-[#E5E7EB] px-3 text-sm text-text-1 placeholder:text-text-2/50 focus:outline-none focus:ring-0 focus:border-primary bg-white'
...
export default function ContactForm() {
  ...
  return (
    <section id="contact" className="w-full px-4 py-14 sm:py-20">
      ...
      >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            required
            rows={5}
            className="w-full rounded-xl border border-[#E5E7EB] px-3 py-2.5 text-sm text-text-1 placeholder:text-text-2/50 focus:outline-none focus:ring-0 focus:border-primary resize-none bg-white"
          />
        </div>
