...
export default function SmartMarketing() {
  return (
    <section className="w-full px-4 py-16 sm:py-20">
      ...
      <div className="mx-auto max-w-7xl mb-16 rounded-2xl bg-[#FAFAFB] px-10 pt-10 flex flex-col md:flex-row items-center md:items-end justify-center gap-2 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {features.map(({ icon: Icon, title, description }) => (
          <div key={title} className="flex flex-col items-center text-center gap-3">
            ...
            <p className="text-xl font-semibold text-text-1">{title}</p>
